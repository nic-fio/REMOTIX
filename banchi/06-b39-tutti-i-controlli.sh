#!/bin/bash
#
# 06-b39-tutti-i-controlli.sh — ⭐ i controlli positivi di TUTTI gli attrezzi
# di A4, in un colpo solo e senza toccare niente di vivo.
#
#   bash banchi/06-b39-tutti-i-controlli.sh
#
...
controlla "06-b39-verdetto.py — il verdetto sotto contesa" \
	python3 "$QUI/06-b39-verdetto.py" --controllo
controlla "06-b39-guasto.py — l'innesto della cura tolta" \
	python3 "$QUI/06-b39-guasto.py" --controllo
