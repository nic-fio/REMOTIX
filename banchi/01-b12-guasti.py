...
guasto(
    ...
    nota="⭐ PROVATO PER LA PRIMA VOLTA l'11 agosto 2026 — e non era «mai "
         ...
         "`fondamenta/strumenti/sshpw.py`, che sul server non c'e'.  Lanciato di la' "
...
guasto(
    ...
    nota="⭐⭐⭐ **P5 E' CERTIFICATO — `[M]` la notte fra l'11 e il 12 agosto "
         ...
         "dei comandi privilegiati (`fondamenta/strumenti/sshpw.py` digita la password "
...
guasto(
    ...
    nota="⛔⛔ **SCADUTA E NON RIGIRABILE LA NOTTE DEL 13 AGOSTO 2026, E LA "
         ...
         "perda un'ora.\n"
         "  La certificazione e' scaduta (`pagina.html` e' cambiata per curare "
         "le sonde HEVC).  L'albero di copia e' stato ricostruito, il guasto "
         "innestato (impronta `b41e4f16…` → `d7d3e86a…`, verificata) e il "
         "banco rigirato: ⛔ **e' uscito 0, e la marca `sano/V3s: rosso` non "
         "e' comparsa**.  ⇒ **Il guasto c'era e il banco non e' diventato "
         "rosso.**\n"
         "  ⭐ **La spiegazione piu' probabile, e non e' del banco**: quella "
         "sera si e' scoperto che i banchi browser **non girano sull'Xvfb che "
         "accendono** — Chrome ignora `DISPLAY` e va su Wayland, cioe' sul "
         "desktop dell'utente, **2560x1080**.  Il caso `V3s` guarda se la "
         "barra di scorrimento muove `clientWidth` quando la tela si accende: "
         "su una finestra larga il contenuto **non trabocca**, quindi la barra "
         "non compare *nemmeno senza* la riga di stile che il guasto toglie.\n"
         "  ⛔ **Non e' stata forzata, e non e' stata allargata**: la voce "
         "resta **NON CERTIFICATA**, che e' la cosa vera.  ⇒ Si rigira **dopo** "
         "che il palco dei banchi browser e' stato messo a posto — ed e' il "
         "primo lavoro della prossima sessione.  ⚠ E se anche allora restasse "
         "verde, allora il guasto e' invecchiato e va **rimisurato**, non "
         "ritoccato a mente.\n"
         "⚠ LA COPIA QUI DEV'ESSERE UN ALBERO, NON UN FILE, e `prepara_copia()` "
