/*
 * 04-b24-testimone.c — ⭐ IL LATO CHE RICEVE, senza browser.
 *
 *   ./04-b24-testimone [--misura 1600x900]
 *
...
{
	int fd = memfd_create("b24-testimone", MFD_CLOEXEC);
...
int main(int argc, char **argv)
{
	...
	xdg_toplevel_set_title(finestra, "B24 testimone");
	xdg_toplevel_set_app_id(finestra, "remotix.b24");
