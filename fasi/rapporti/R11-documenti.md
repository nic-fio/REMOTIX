...
| **i rimandi fra documenti, tutti** | ho verificato meccanicamente ogni `<file>.md §<n>` in README, RCP, DECISIONI, LEZIONI e 01-filo-nudo contro le intestazioni dei file bersaglio: **due soli** falliscono, ed è R11.18. `PIANO.md` §0.1-§0.4, `LEZIONI.md` §1.9/§2.1/§2.3/§9, `DECISIONI.md` §5.0-ter/§5-bis.8/§2.6, `STUDI.md` §web §3.1 esistono tutti |
